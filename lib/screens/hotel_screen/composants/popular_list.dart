...
class HotelsPopularList extends StatefulWidget {
  const HotelsPopularList({Key? key}) : super(key: key);

  @override
  State<HotelsPopularList> createState() => _HotelsPopularListState();
}
...
class _HotelsPopularListState extends State<HotelsPopularList> {
  @override
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate(
          ...
          childCount: hotelsListToulon.length,
        ),
      ),
    );
  }
