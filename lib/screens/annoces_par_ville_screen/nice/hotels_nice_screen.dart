...
import 'package:projet_annuel/screens/annoces_par_ville_screen/nice/hotels_nice_annonces_list.dart';
...
class HotelsNiceScreen extends StatefulWidget {
  const HotelsNiceScreen({Key? key}) : super(key: key);

  @override
  State<HotelsNiceScreen> createState() => _HotelsNiceScreenState();
}

class _HotelsNiceScreenState extends State<HotelsNiceScreen> {
