...
import 'package:projet_annuel/screens/annoces_par_ville_screen/nice/parkings_nice_annonce_list.dart';
...
class ParkingsNiceScreen extends StatefulWidget {
  const ParkingsNiceScreen({Key? key}) : super(key: key);

  @override
  State<ParkingsNiceScreen> createState() => _ParkingsNiceScreenState();
}

class _ParkingsNiceScreenState extends State<ParkingsNiceScreen> {
