...
import 'package:projet_annuel/screens/annoces_par_ville_screen/nice/activites_nice_annonces_list.dart';
...
class ActivitesNiceScreen extends StatefulWidget {
  const ActivitesNiceScreen({Key? key}) : super(key: key);

  @override
  State<ActivitesNiceScreen> createState() => _ActivitesNiceScreenState();
}

class _ActivitesNiceScreenState extends State<ActivitesNiceScreen> {
