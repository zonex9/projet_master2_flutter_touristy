...
class SitestouristiquesNiceScreen extends StatefulWidget {
  const SitestouristiquesNiceScreen({Key? key}) : super(key: key);

  @override
  State<SitestouristiquesNiceScreen> createState() => _SitestouristiquesNiceScreenState();
}

class _SitestouristiquesNiceScreenState extends State<SitestouristiquesNiceScreen> {
      ...
      body: const CustomScrollView(
        ...
        slivers: [
         ...
         // FeedNews(),
          ...
          SitestouristiquesNiceAnnoncesList(),
