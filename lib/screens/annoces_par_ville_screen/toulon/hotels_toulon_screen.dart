...
import 'package:projet_annuel/screens/annoces_par_ville_screen/toulon/hotels_toulon_annonces_list.dart';
...
class HotelsToulonScreen extends StatefulWidget {
  const HotelsToulonScreen({Key? key}) : super(key: key);

  @override
  State<HotelsToulonScreen> createState() => _HotelsToulonScreenState();
}

class _HotelsToulonScreenState extends State<HotelsToulonScreen> {
