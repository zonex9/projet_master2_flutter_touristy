...
class ActivitesToulonAnnoncesList extends StatefulWidget {
  const ActivitesToulonAnnoncesList({Key? key}) : super(key: key);

  @override
  State<ActivitesToulonAnnoncesList> createState() => _ActivitesToulonAnnoncesListState();
}
...
class _ActivitesToulonAnnoncesListState extends State<ActivitesToulonAnnoncesList> {
  @override
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate(
          (ctx, i) {
            return GestureDetector(
             onTap: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: ((context) => OthersActivitesToulonScreen(
                        popularModel: activitesListToulon[i],
                      )),
                ),
              ),
              child: Card(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(activitesListToulon[i].pictureprincipale),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(activitesListToulon[i].title),
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(activitesListToulon[i].pictureprincipale,activitesListToulon[i].picture1, activitesListToulon[i].picture2,activitesListToulon[i].picture3, activitesListToulon[i].title, activitesListToulon[i].desc, activitesListToulon[i].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(activitesListToulon[i].title);                     
                              setState(() {
                                activitesListToulon[i].favorite =
                                    !activitesListToulon[i].favorite;
                              });
                            },
                            
                            icon: activitesListToulon[i].favorite
          ...
          childCount: activitesListToulon.length,
        ),
      ),
    );
  }
