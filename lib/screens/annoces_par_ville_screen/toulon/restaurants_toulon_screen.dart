...
import 'package:projet_annuel/screens/annoces_par_ville_screen/toulon/restaurants_toulon_annonces_list.dart';
...
class RestaurantsToulonScreen extends StatefulWidget {
  const RestaurantsToulonScreen({Key? key}) : super(key: key);

  @override
  State<RestaurantsToulonScreen> createState() => _RestaurantsToulonScreenState();
}

class _RestaurantsToulonScreenState extends State<RestaurantsToulonScreen> {
