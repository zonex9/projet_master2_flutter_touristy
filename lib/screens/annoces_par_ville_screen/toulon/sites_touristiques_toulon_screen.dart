...
class SitesTouristiquesToulonScreen extends StatefulWidget {
  const SitesTouristiquesToulonScreen({Key? key}) : super(key: key);

  @override
  State<SitesTouristiquesToulonScreen> createState() => _SitesTouristiquesToulonScreenState();
}

class _SitesTouristiquesToulonScreenState extends State<SitesTouristiquesToulonScreen> {
      ...
      body: const CustomScrollView(
        ...
        slivers: [
         ...
         // FeedNews(),
          ...
          SitestouristiquesToulonAnnoncesList(),
