...
class ReservationsPopularList extends StatefulWidget {
  const ReservationsPopularList({Key? key}) : super(key: key);
  @override
  State<ReservationsPopularList> createState() => _ReservationsPopularListState();
}

     User? user = FirebaseAuth.instance.currentUser;


class _ReservationsPopularListState extends State<ReservationsPopularList> {
    var test =0 ;
  ...
  return SliverPadding(
   ...
   sliver: Container(
    ...
    stream: FirebaseFirestore.instance.collection('réservations')
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                               ...
                               Text(
                                'Sortie avant : \€${items[i].get('datefin')}',
                                style: const TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 10,
                                ),
