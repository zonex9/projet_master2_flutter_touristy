...
class ReservationsCategoryList extends StatefulWidget {
  const ReservationsCategoryList({Key? key}) : super(key: key);

  @override
  State<ReservationsCategoryList> createState() => _ReservationsCategoryListState();
}

class _ReservationsCategoryListState extends State<ReservationsCategoryList> {
