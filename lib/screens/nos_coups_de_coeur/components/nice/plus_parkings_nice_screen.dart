...
class PlusParkingsNiceList extends StatefulWidget {
  const PlusParkingsNiceList({Key? key}) : super(key: key);

  @override
  State<PlusParkingsNiceList> createState() => _PlusParkingsNiceListState();
}

class _PlusParkingsNiceListState extends State<PlusParkingsNiceList> {
  ...
  Widget build(BuildContext context) {
      return SizedBox(
        ...
        child: ListView.builder(
          ...
          itemCount: parkingsListNice.length,
          itemBuilder: (ctx, i) {
            return Padding(
              ...
              child: GestureDetector(
                onTap: () {
                 ...
                 Navigator.push(
                  context, MaterialPageRoute(builder: (context) => OthersHotelsNiceScreen( popularModel: parkingsListNice[i])));
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image:  AssetImage(
                            parkingsListNice[i].pictureprincipale,
                          ),
                          fit: BoxFit.cover,
                      ...
                      child:  Text(  parkingsListNice[i].title,style: const TextStyle(color: Color.fromARGB(255, 255, 255, 255))),
                    ),
