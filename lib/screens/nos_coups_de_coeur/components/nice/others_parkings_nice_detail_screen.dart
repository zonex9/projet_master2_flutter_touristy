...
class OthersParkingsNiceScreen extends StatelessWidget {
 final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   OthersParkingsNiceScreen({
    Key? key,
            ...
            child: Row(
              ...
              children: [
               ...
               IconButton(
                           ...
                           //     postDetailsToFirestore(parkingsListNice[0].pictureprincipale,parkingsListNice[0].picture1, parkingsListNice[0].picture2,parkingsListNice[0].picture3, parkingsListNice[0].title, parkingsListNice[0].desc, parkingsListNice[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(parkingsListNice[0].title);                     
                             
                            },
                            
                            icon: parkingsListNice[0].favorite
