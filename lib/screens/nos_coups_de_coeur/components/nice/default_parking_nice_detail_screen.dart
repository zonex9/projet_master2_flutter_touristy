...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/nice/plus_parkings_nice_screen.dart';
...
class DefaultParkingNiceCoupsDeCoeurScreen extends StatelessWidget {
  final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   DefaultParkingNiceCoupsDeCoeurScreen({
    Key? key,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/pictures/villes/nice/parkings/parking1/1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '\€${popularModel.price} par stationnement',
               ...
               IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(hotelsListNice[0].pictureprincipale,hotelsListNice[0].picture1, hotelsListNice[0].picture2,hotelsListNice[0].picture3, hotelsListNice[0].title, hotelsListNice[0].desc, hotelsListNice[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(hotelsListNice[0].title);                     
                             
                            },
                            
                            icon: hotelsListNice[0].favorite
                    ...
                    Container(
                     ...
                     borderRadius: BorderRadius.circular(15),
                        ...
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/nice/parkings/parking1/2.jpg',
                          ),
                          fit: BoxFit.cover,
                  ...
                  children: [
                    ...
                    borderRadius: BorderRadius.circular(15),
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/nice/parkings/parking1/3.jpg',
                          ),
                          fit: BoxFit.cover,
                      ...
                      decoration:  BoxDecoration(
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/nice/parkings/parking1/4.jpg',
                          ),
                          fit: BoxFit.cover,
