...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/nice/plus_sitestouristiques_nice_screen.dart';
...
class OthersSitestouristiquesNiceScreen extends StatelessWidget {
 final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   OthersSitestouristiquesNiceScreen({
    Key? key,
      ...
      body: ListView(
       ...
       //***************plus d'activites **********************/
         ...
         const Padding(
            padding: EdgeInsets.symmetric(horizontal: 10),
            child: Text(
              "Plus de sites touristiques à Nice",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
