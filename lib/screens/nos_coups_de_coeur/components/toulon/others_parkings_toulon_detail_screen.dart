...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/toulon/plus_parkings_toulon_screen.dart';
...
class OthersParkingsToulonScreen extends StatelessWidget {
 final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   OthersParkingsToulonScreen({
    Key? key,
              ...
              children: [
               ...
               IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(parkingsListToulon[0].pictureprincipale,parkingsListToulon[0].picture1, parkingsListToulon[0].picture2,parkingsListToulon[0].picture3, parkingsListToulon[0].title, parkingsListToulon[0].desc, parkingsListToulon[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(parkingsListToulon[0].title);                     
                             
                            },
                            
                            icon: parkingsListToulon[0].favorite
