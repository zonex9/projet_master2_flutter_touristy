...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/toulon/plus_sitestouristiques_toulon_screen.dart';
...
class DefaultSitetouristiqueToulonCoupsDeCoeurScreen extends StatelessWidget {
  final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   DefaultSitetouristiqueToulonCoupsDeCoeurScreen({
    Key? key,
      ...
      body: ListView(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('../assets/pictures/villes/toulon/Sitetouristiques/Sitetouristique1/1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              children: [
               ...
               IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(sitestouristiquesListToulon[0].pictureprincipale,sitestouristiquesListToulon[0].picture1, sitestouristiquesListToulon[0].picture2,sitestouristiquesListToulon[0].picture3, sitestouristiquesListToulon[0].title, sitestouristiquesListToulon[0].desc, sitestouristiquesListToulon[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(sitestouristiquesListToulon[0].title);                     
                             
                            },
                            
                            icon: sitestouristiquesListToulon[0].favorite
                    ...
                    Container(
                     ...
                     borderRadius: BorderRadius.circular(15),
                        ...
                        image: const DecorationImage(
                          image:  AssetImage(
                            '../assets/pictures/villes/toulon/sitetouristiques/Sitetouristique1/2.jpg',
                          ),
                          fit: BoxFit.cover,
                  ...
                  children: [
                    ...
                    borderRadius: BorderRadius.circular(15),
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            '../assets/pictures/villes/toulon/sitetouristiques/Sitetouristique1/3.jpg',
                          ),
                          fit: BoxFit.cover,
                      ...
                      decoration:  BoxDecoration(
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            '../assets/pictures/villes/toulon/sitetouristiques/Sitetouristique1/4.jpg',
                          ),
                          fit: BoxFit.cover,
       ...
       //***************plus d'hotels **********************/
         ...
         const Padding(
            padding: EdgeInsets.symmetric(horizontal: 10),
            child: Text(
              "Plus de Sitetouristiques à Toulon",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
       ...
       const SizedBox(height: 15),
            ...
            //**********start plus hotels **************/
                       const   PlusSitestouristiquesNiceList(),
            ...
            child: AppButtonReserver.normalButton(
                title: 'Réserver',
                  onPress: () async {
                        ...
                        List<String> reservationAnnonce = [popularModel.title, popularModel.pictureprincipale,popularModel.price.toString(),"Toulon"];
                        SharedPreferences prefs = await SharedPreferences.getInstance();
                        prefs.setStringList('reservationAnnonce', reservationAnnonce);
                  //      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const reservationHotelNiceScreen1()));
                      },
