...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/toulon/plus_activites_toulon_screen.dart';
...
class OthersActivitesToulonScreen extends StatelessWidget {
 final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   OthersActivitesToulonScreen({
    Key? key,
              ...
              children: [
               ...
               IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(activitesListToulon[0].pictureprincipale,activitesListToulon[0].picture1, activitesListToulon[0].picture2,activitesListToulon[0].picture3, activitesListToulon[0].title, activitesListToulon[0].desc, activitesListToulon[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(activitesListToulon[0].title);                     
                             
                            },
                            
                            icon: activitesListToulon[0].favorite
