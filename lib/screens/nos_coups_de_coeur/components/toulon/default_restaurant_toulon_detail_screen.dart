...
import 'package:projet_annuel/screens/nos_coups_de_coeur/components/toulon/plus_restaurants_toulon_screen.dart';
...
class DefaultRestaurantToulonCoupsDeCoeurScreen extends StatelessWidget {
  final PopularModel popularModel;
  final _auth = FirebaseAuth.instance;

  
   DefaultRestaurantToulonCoupsDeCoeurScreen({
    Key? key,
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/pictures/villes/toulon/restaurants/restaurant1/1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              children: [
               ...
               IconButton(
                            ...
                            onPressed: () {
                                ...
                                postDetailsToFirestore(restaurantsListToulon[0].pictureprincipale,restaurantsListToulon[0].picture1, restaurantsListToulon[0].picture2,restaurantsListToulon[0].picture3, restaurantsListToulon[0].title, restaurantsListToulon[0].desc, restaurantsListToulon[0].price);
                            print("uid :");
                            print(user?.uid);
                            print("titre : ");
                            print(restaurantsListToulon[0].title);                     
                             
                            },
                            
                            icon: restaurantsListToulon[0].favorite
                    ...
                    Container(
                     ...
                     borderRadius: BorderRadius.circular(15),
                        ...
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/toulon/restaurants/restaurant1/2.jpg',
                          ),
                          fit: BoxFit.cover,
                  ...
                  children: [
                    ...
                    borderRadius: BorderRadius.circular(15),
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/toulon/restaurants/restaurant1/3.jpg',
                          ),
                          fit: BoxFit.cover,
                      ...
                      decoration:  BoxDecoration(
                       ...
                       // borderRadius: BorderRadius.circular(15),
                        image: const DecorationImage(
                          image:  AssetImage(
                            'assets/pictures/villes/toulon/restaurants/restaurant1/4.jpg',
                          ),
                          fit: BoxFit.cover,
