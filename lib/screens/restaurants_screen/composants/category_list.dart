...
class RestaurantsCategoryList extends StatefulWidget {
  const RestaurantsCategoryList({Key? key}) : super(key: key);

  @override
  State<RestaurantsCategoryList> createState() => _RestaurantsCategoryListState();
}

class _RestaurantsCategoryListState extends State<RestaurantsCategoryList> {
