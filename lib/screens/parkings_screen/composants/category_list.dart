...
import '../../sites_touristiques_screen/sites_touristiques_screen.dart';

class parkingsCategoryList extends StatefulWidget {
  const parkingsCategoryList({Key? key}) : super(key: key);

  @override
  State<parkingsCategoryList> createState() => _parkingsCategoryListState();
}

class _parkingsCategoryListState extends State<parkingsCategoryList> {
